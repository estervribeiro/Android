...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "Lista de Contatos", Toast.LENGTH_LONG).show();
        ...
        btNovoContato.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Toast.makeText(MainActivity.this, "Novo Contato", Toast.LENGTH_LONG).show();
    ...
    public void onCreateContextMenu(ContextMenu menu, View v, ContextMenu.ContextMenuInfo menuInfo) {
        ...
        inflater.inflate(R.menu.menu_context_lista_contatos, menu);
    }
